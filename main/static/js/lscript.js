...
const isForgotPassword = currentPath.startsWith("/forgot-password");
const isofflineBookingSuccess = currentPath.startsWith("/offline");
const isuploadimage = currentPath === "/admin/gallery/pending";
